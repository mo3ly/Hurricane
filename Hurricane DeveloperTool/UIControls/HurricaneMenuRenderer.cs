...
{
    public class HurricaneMenuRenderer : ToolStripProfessionalRenderer
    {
        private Color primaryColor;
        private Color textColor;
        private int arrowThickness;

        public HurricaneMenuRenderer(bool isMainMenu, Color primaryColor, Color textColor)
            : base(new HurricaneMenuColorTable(isMainMenu, primaryColor))
        {
